...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        myViewHolder.textViewNum.setText(String.valueOf(data.get(i).getInt(DBManager.DbHelper.FIELD_POS)));
        myViewHolder.textViewBreef.setText(data.get(i).getString(DBManager.DbHelper.FIELD_NOTE));
    ...
    public int getIdByPosition(int position){
        return data.get(position).getInt(DBManager.DbHelper.FIELD_ID);
    }
